...
export const ru: Record<MessageKey, string> = {
  ...
  "onboarding.intro": `Привет! Я Bistro, твой репетитор по языкам 🍽️

Как устроен день:

Я присылаю 10 слов. Используй их в разговоре со мной — текстом или голосом, как удобно. Я буду поправлять по ходу.

Если используешь все 10, день закроется сам. Хороший разговор тоже считается — примерно пять обменов. Или отправь /done, когда закончишь. Всё считается одинаково.

И слова — только точка старта. Если хочешь поговорить про выходные, работу или ни о чём конкретном — так и сделай. Практика есть практика.
...
Какой язык ты хочешь учить?`,
  ...
  "daily.goalLine": "Используй их со мной сегодня — текстом или голосом. /done, когда закончишь.",
  ...
  "session.wrapUpStreakExplainer":
    "Это твоя первая сессия. Делай по одной в день — серия растёт; пропустишь день — она сбросится.",
