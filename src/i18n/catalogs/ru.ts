...
Какой язык ты хочешь учить?`,
  ...
  "inactivity.neverStarted24h": "{greeting} Готов начать практику? Просто напиши мне {flag}",
  "inactivity.neverStarted72h":
    "Я на месте, когда будешь готов! Даже 5 минут {language} уже имеют значение 💪",
  "inactivity.weekPause":
    "{greeting} 👋 Ты не практиковался неделю, поэтому я пока ставлю слова дня на паузу. Когда захочешь продолжить, просто напиши любое сообщение — продолжим с того места.",
  "inactivity.recall":
    'Помнишь, что значит «{word}»? Это «{translation}» — и ты это уже выучил! Возвращайся и продолжай. 💪',
  "inactivity.monthProgress":
    "Ты уже выучил {count} слов на языке {language}. Это настоящий прогресс — не дай ему пропасть. Следующее слово ждёт. 👀",
  "inactivity.finalPause":
    "Мы постарались на славу! 😄 Ставлю все сообщения на паузу, чтобы не мешать. Когда захочешь снова взяться за {language}, просто напиши — я буду здесь.",
